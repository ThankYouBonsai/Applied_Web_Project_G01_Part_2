        ...
        <?php 
            ...
            function validate($value, $type, $arg, $regex) {
                ...
                if (preg_match($regex, $value) == false && $regex != "") { 
                    // value does not have regex for specified regex
                    leaveProcess(); 
                }
            ...
            // encode skills for import into database
            $jsonData = json_encode($skills);

            $other_skill = $_POST['otherskills'];


            // Validate fields for required fields and database entry
