...
CREATE TABLE `eoi` (
  `eoi_id` int(11) NOT NULL PRIMARY KEY AUTO_INCREMENT,
...
CREATE TABLE `job_listings` (
  ...
  `reference_code` varchar(10) NOT NULL UNIQUE KEY,
